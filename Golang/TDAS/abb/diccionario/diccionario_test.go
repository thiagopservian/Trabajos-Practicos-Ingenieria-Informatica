...
func buscarIterador(clave string, claves []string) int {
...
func TestIteradorInternoClaves(t *testing.T) {
	...
	require.NotEqualValues(t, -1, buscarIterador(cs[0], claves))
	require.NotEqualValues(t, -1, buscarIterador(cs[1], claves))
	require.NotEqualValues(t, -1, buscarIterador(cs[2], claves))
...
func TestDiccionarioIterar(t *testing.T) {
	...
	require.NotEqualValues(t, -1, buscarIterador(primero, claves))

	iter.Siguiente()
	segundo, segundo_valor := iter.VerActual()
	require.NotEqualValues(t, -1, buscarIterador(segundo, claves))
	require.EqualValues(t, valores[buscarIterador(segundo, claves)], segundo_valor)
	...
	require.NotEqualValues(t, -1, buscarIterador(tercero, claves))
